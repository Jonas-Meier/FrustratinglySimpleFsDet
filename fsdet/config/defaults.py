...
_CC.DATASETS.SUPPORTED_DATASETS = ["coco",
                                   ...
                                   "isaid_high_gsd", "isaid_no_overlap", "isaid_gsd_01", "isaid_gsd_02",
                                   "isaid_gsd_03", "isaid_gsd_04",
...
_CC.DATA_DIR = CN({
    ...
    "isaid_gsd_01": os.path.join(_CC.ROOT_DIR, 'datasets', 'isaid_gsd_01'),
    "isaid_gsd_02": os.path.join(_CC.ROOT_DIR, 'datasets', 'isaid_gsd_02'),
    "isaid_gsd_03": os.path.join(_CC.ROOT_DIR, 'datasets', 'isaid_gsd_03'),
    "isaid_gsd_04": os.path.join(_CC.ROOT_DIR, 'datasets', 'isaid_gsd_04'),
...
_CC.DATA_SAVE_PATH_PATTERN = CN({
    ...
    "isaid_gsd_01": os.path.join(_CC.ROOT_DIR, 'datasets', "isaid_gsd_01split", "isaid_gsd_01split_{}"),
    "isaid_gsd_02": os.path.join(_CC.ROOT_DIR, 'datasets', "isaid_gsd_02split", "isaid_gsd_02split_{}"),
    "isaid_gsd_03": os.path.join(_CC.ROOT_DIR, 'datasets', "isaid_gsd_03split", "isaid_gsd_03split_{}"),
    "isaid_gsd_04": os.path.join(_CC.ROOT_DIR, 'datasets', "isaid_gsd_04split", "isaid_gsd_04split_{}"),
...
_CC.CONFIG_DIR_PATTERN = CN({
    ...
    "isaid_gsd_01": os.path.join('configs', 'iSAID-gsd-01-detection', "isaid_gsd_01split_{}"),
    "isaid_gsd_02": os.path.join('configs', 'iSAID-gsd-02-detection', "isaid_gsd_02split_{}"),
    "isaid_gsd_03": os.path.join('configs', 'iSAID-gsd-03-detection', "isaid_gsd_03split_{}"),
    "isaid_gsd_04": os.path.join('configs', 'iSAID-gsd-04-detection', "isaid_gsd_04split_{}"),
...
_CC.CKPT_DIR_PATTERN = CN({
    ...
    "isaid_gsd_01": os.path.join('checkpoints', 'isaid_gsd_01_{}'),
    "isaid_gsd_02": os.path.join('checkpoints', 'isaid_gsd_02_{}'),
    "isaid_gsd_03": os.path.join('checkpoints', 'isaid_gsd_03_{}'),
    "isaid_gsd_04": os.path.join('checkpoints', 'isaid_gsd_04_{}'),
...
_CC.TRAIN_IMG_DIR = CN({
    ...
    "isaid_gsd_01": os.path.join('datasets', 'isaid_gsd_01', 'images', 'train'),
    "isaid_gsd_02": os.path.join('datasets', 'isaid_gsd_02', 'images', 'train'),
    "isaid_gsd_03": os.path.join('datasets', 'isaid_gsd_03', 'images', 'train'),
    "isaid_gsd_04": os.path.join('datasets', 'isaid_gsd_04', 'images', 'train'),
...
_CC.TEST_IMG_DIR = CN({
    ...
    "isaid_gsd_01": os.path.join('datasets', 'isaid_gsd_01', 'images', 'val'),
    "isaid_gsd_02": os.path.join('datasets', 'isaid_gsd_02', 'images', 'val'),
    "isaid_gsd_03": os.path.join('datasets', 'isaid_gsd_03', 'images', 'val'),
    "isaid_gsd_04": os.path.join('datasets', 'isaid_gsd_04', 'images', 'val'),
...
_CC.TRAIN_ANNOS = CN({
    ...
    "isaid_gsd_01": os.path.join('datasets', 'isaid_gsd_01', 'annotations', 'instancesonly_filtered_train.json'),
    "isaid_gsd_02": os.path.join('datasets', 'isaid_gsd_02', 'annotations', 'instancesonly_filtered_train.json'),
    "isaid_gsd_03": os.path.join('datasets', 'isaid_gsd_03', 'annotations', 'instancesonly_filtered_train.json'),
    "isaid_gsd_04": os.path.join('datasets', 'isaid_gsd_04', 'annotations', 'instancesonly_filtered_train.json'),
...
_CC.TEST_ANNOS = CN({
    ...
    "isaid_gsd_01": os.path.join('datasets', 'isaid_gsd_01', 'annotations', 'instancesonly_filtered_val.json'),
    "isaid_gsd_02": os.path.join('datasets', 'isaid_gsd_02', 'annotations', 'instancesonly_filtered_val.json'),
    "isaid_gsd_03": os.path.join('datasets', 'isaid_gsd_03', 'annotations', 'instancesonly_filtered_val.json'),
    "isaid_gsd_04": os.path.join('datasets', 'isaid_gsd_04', 'annotations', 'instancesonly_filtered_val.json'),
...
# pendant to DATALOADER.FILTER_EMPTY_ANNOTATIONS but for inference.
# WARNING: This setting can drastically influence the overall detection performance!
_CC.TEST.FILTER_EMPTY_ANNOTATIONS = False
